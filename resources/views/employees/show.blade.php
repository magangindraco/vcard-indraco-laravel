    ...
    <div class="wrapper shadow shadow-lg">
        ...
        <header class="kolom-header text-center">
            <div class="container-fluid">
                ...
                <div class="py-4">
                    <div class="title mb-2"><span>{{ $employee->name }}</span></div>
                    <div class="text"><span>PT. INDRACO GLOBAL INDONESIA</span></div>
                    <div class="text"><span>{{ $employee->position }}</span></div>
                </div>
                ...
                <ul class="list-unstyled m-0">
                    <li class="media">
                        ...
                        <div class="media-body">
                            <a href="tel:{{ $employee->mobile }}" target="_blank">
                                <div class="media-title">{{ $employee->mobile }}</div>
                    ...
                    <li class="media">
                        <img src="{{ asset('assets/img/ikon-phone.png') }}" width="25" height="25"
                            class="me-4" alt="">
                        <div class="media-body">
                            <a href="tel:{{ $employee->phone_number }}" target="_blank">
                                <div class="media-title">{{ $employee->office }}</div>
                    ...
                    <li class="media">
                        ...
                        <div class="media-body">
                            <a href="mailto:{{ $employee->email }}" target="_blank">
                                <div class="media-title">{{ $employee->email }}</div>
